...
class TestKauppa(unittest.TestCase):
    ...
    def test_maksettaessa_ostos_pankin_metodia_tilisiirto_kutsutaan_oikeilla_argumenteilla2(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_asioinnin_aloittaminen(self):
        pankki_mock = Mock()
        viitegeneraattori_mock = Mock()
    ...
    def test_tuotteen_poistaminen(self):
        ...
        # varmistetaan, että metodia tilisiirto on kutsuttu
        pankki_mock.tilisiirto.assert_called_with("pekka", ANY, "12345","33333-44455", 2)
        # toistaiseksi ei välitetä kutsuun liittyvistä argumenteista