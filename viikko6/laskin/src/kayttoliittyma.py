...
class Kayttoliittyma:
    ...
    def _suorita_komento(self, komento):
        ...
        if komento == Komento.KUMOA:
            if self._viimeisin_komento is not None:
        ...
        if self._viimeisin_komento is None:
...
class Summa:
    ...
    def suorita(self):
        self._edellinen = self.sovelluslogiikka.arvo()
        return self.sovelluslogiikka.plus(int(self.syote()))
    
    def kumoa(self):
        if self._edellinen is not None:
            self.sovelluslogiikka.aseta_arvo(self._edellinen)
            self._edellinen = None
...
class Kumoa:
    ...
    def suorita(self):
        if self.sovelluslogiikka.arvo:
            return self.sovelluslogiikka.aseta_arvo(int(self.syote()))
        else:
            return self.sovelluslogiikka.nollaa()
